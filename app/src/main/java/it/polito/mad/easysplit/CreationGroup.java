...
public class CreationGroup extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                root.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot usersSnap) {
                        ...
                        List<String> participants = Arrays.asList(participantsStr.split("\\s+"));
                        String groupName = groupNameEdit.getText().toString();

                        AsyncTask task = new CreateGroupTask(root);
                        task.execute(groupName, participants);
                    }
    ...
    private class CreateGroupTask extends AsyncTask<Object, Void, Void> {
        private final DatabaseReference mRoot;

        CreateGroupTask(DatabaseReference root) {
            this.mRoot = root;
        }
        ...
        protected Void doInBackground(Object... params) {
            ...
            List<String> emails = (List<String>) params[1];
